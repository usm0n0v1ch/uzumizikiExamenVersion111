    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('customer', 'customer'), ('admin', 'admin'), ('government', 'government')], default='customer', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('ожидается ответ', 'ожидается ответ'), ('принят', 'принят'), ('отклонен', 'отклонен')], default='ожидается ответ', max_length=255)),
